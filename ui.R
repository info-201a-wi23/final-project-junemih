...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel("Introduction", 
             img(src = "spotify.jpeg", height = 320, width = 600),
             h3("Background"),
